...
type
  ...
  public
    ...
    function GetMass : Double; inline;

    function GetOrientation : Double; inline;
    procedure SetOrientation(Orientation: Double); inline;

    function GetPosition : TVector2; inline;
    procedure SetPosition(const Position: TVector2); inline;

    function GetVelocity : TVector2; inline;
    function GetAngularVelocity : Double; inline;

    function getWorldCoordinatesVector(const localVector: TVector2) : TVector2; inline;
    function getWorldCoordinatesPoint(const localPoint: TVector2) : TVector2; inline;

    function getLocalCoordinatesVector(const globalVector: TVector2) : TVector2; inline;
    function getLocalCoordinatesPoint(const globalPoint: TVector2) : TVector2; inline;

    function getAbsoluteVelocityForLocalPoint(const localPoint: TVector2) : TVector2; inline;
  ...
  TJoint = class
  private
    function GetChild: TArticulatedRigidBody; inline;
    function GetChildJPos: TVector2; inline;
    function GetParent: TArticulatedRigidBody; inline;
    function GetParentJPos: TVector2; inline;
    function GetUseJointLimits: Boolean; inline;
    procedure SetUseJointLimits(Value: Boolean); inline;
  public
    ...
    procedure computeRelativeOrientation(var aRel: Double); inline;
    procedure fixJointConstraints;

    procedure setTorque(t: Double); inline;
  ...
  strict private
    ...
    procedure SetRoot(Root: TArticulatedRigidBody); inline;
  ...
  public
    ...
    procedure addArticulatedRigidBody(arb: TArticulatedRigidBody); inline;
    procedure addJoint(joint_disown: TJoint);  inline;
    procedure addContact(const Contact: TContactPoint); inline;
    procedure clearContacts; inline;

    procedure addJointsToList(otherJoints: TList<TJoint>); inline;

    procedure fixJointConstraints;
    procedure completeFigure; inline;

    property JointCount : Integer read GetJointCount;
    function getJoint(i: Integer) : TJoint; inline;
    function getJointIndex(joint: TJoint) : Integer; overload; inline;
    function getJointIndex(const jName: String) : Integer; overload; inline;
    function getJointByName(const jName: String) : TJoint; inline;

    function getARBByName(const Name: String) : TArticulatedRigidBody; inline;
  end;
  ...
  public
    ...
    function GetRevertAngle : Double;
  end;

function VectorDelta(const V1, V2: TVector2) : TVector2; inline;
...
function TCharacter.GetRevertAngle: Double;
var
  RootAngle: Double;
begin
  RootAngle:= Root.GetOrientation;
  Result:= Trunc((RootAngle + Pi * Sign(RootAngle)) / (Pi * 2)) * (Pi * 2);
end;
