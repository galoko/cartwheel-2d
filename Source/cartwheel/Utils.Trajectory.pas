...
type
  ...
  public
    ...
    function getKnotValue(i: Integer) : Double; inline;
    function getKnotPosition(i: Integer) : Double; inline;
    procedure setKnotValue(i: Integer; val: Double); inline;
    procedure setKnotPosition(i: Integer; pos: Double); inline;
    function getMinPosition : Double; inline;
    function getMaxPosition : Double; inline;
    function getKnotCount : Integer; inline;
    procedure addKnot(t, val: Double); inline;
    procedure removeKnot(i: Integer); inline;
